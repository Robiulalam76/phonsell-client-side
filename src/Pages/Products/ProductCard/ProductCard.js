...
const ProductCard = ({ product }) => {
    ...
    const handleWishlist = (id) => {
        ...
        if (id === wishlist.serviceId) {
            fetch(`http://localhost:5000/wishlist/${wishlist.serviceId}`, {
                method: 'DELETE',
                headers: {
            ...
            <div className="p-3">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                        <button onClick={() => handleWishlist(_id)} type="button" title="Like post" className="flex items-center justify-center">

                            {
                                wishlised ?
                                    <img className="w-5 h-5" src="https://img.icons8.com/emoji/2x/heart-suit.png" alt="" />
                                    :
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className=" w-5 h-5 fill-current">
