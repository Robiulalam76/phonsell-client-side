...
const AdvertiseReportModal = ({ modalData, closeModal }) => {
    const { user, logout } = useContext(AuthContext)
    const { serviceId, time, seller, verify, email, categoryId, brand, name, image, price, location, sold, condition, used, originalPrice, model, authenticity, features, description, } = modalData;
...
export default AdvertiseReportModal;